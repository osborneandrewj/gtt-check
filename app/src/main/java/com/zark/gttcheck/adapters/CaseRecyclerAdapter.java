...
public class CaseRecyclerAdapter
        extends FirestoreRecyclerAdapter<GttCase, CaseRecyclerAdapter.GttCaseViewHolder>{
    ...
    public CaseRecyclerAdapter(@NonNull FirestoreRecyclerOptions<GttCase> options,
