...
public class GttCaseListAdapterOld extends FirebaseRecyclerAdapter<
        GttCase, GttCaseListAdapterOld.GttCaseViewHolder> {
    ...
    public GttCaseListAdapterOld(@NonNull FirebaseRecyclerOptions<GttCase> options,
